            ...
            self.parseCommonItem(function (err, result) {
                ...
                if (err) {
                    ...
                    //method call exception for [,] or [)] tokens e.g indexOf(Title,'...')
                            ...
                            (function () {
                                var op = _this.getOperator(self.currentToken);
                                if (op == null) {
                                    callback.call(self, new Error('Expected operator.'));
                                } else {
                                    _this.moveNext();
                                    _this.parseCommonItem(function (err, right) {
                                        if (err) {
                                            callback.call(self, err);
                                        } else {
                                            var _ret2 = function () {
                                                ...
                                                if (!self.atEnd() && LogicalExpression.isLogicalOperator(self.getOperator(self.currentToken))) {
                                                    var _ret3 = function () {
                                                        ...
                                                        return {
                                                            v: {
                                                                v: self.parseCommon(function (err2, expr2) {
                                                                    if (err2) {
                                                                        callback(err2);
                                                                    } else {
...
var LiteralToken = exports.LiteralToken = function (_Token) {
    ...
    function LiteralToken(value, literalType) {
        ...
        var _this2 = _possibleConstructorReturn(this, (LiteralToken.__proto__ || Object.getPrototypeOf(LiteralToken)).call(this, Token.TokenType.Literal));

        _this2.value = value;
        _this2.literalType = literalType;
        return _this2;
    }
...
var IdentifierToken = exports.IdentifierToken = function (_Token2) {
    ...
    function IdentifierToken(name) {
        ...
        var _this3 = _possibleConstructorReturn(this, (IdentifierToken.__proto__ || Object.getPrototypeOf(IdentifierToken)).call(this, Token.TokenType.Identifier));

        _this3.identifier = name;
        return _this3;
    }
...
var SyntaxToken = exports.SyntaxToken = function (_Token3) {
    ...
    function SyntaxToken(chr) {
        ...
        var _this4 = _possibleConstructorReturn(this, (SyntaxToken.__proto__ || Object.getPrototypeOf(SyntaxToken)).call(this, Token.TokenType.Syntax));
