...
var SqlFormatter = exports.SqlFormatter = function () {
    ...
    _createClass(SqlFormatter, [{
        ...
        value: function formatComparison(comparison) {
            if (comparison == null || typeof comparison === 'undefined') return '(%s IS NULL)';
            if ((typeof comparison === 'undefined' ? 'undefined' : _typeof(comparison)) === 'object') {
                ...
                if (compares.length == 0) return '(%s IS NULL)';else {
                    ...
                    for (var i = 0; i < compares.length; i++) {
                        var key = compares[i];
                        if (QueryExpression.ComparisonOperators[key] === undefined) throw new Error(sprintf.sprintf('Unknown operator %s.', key));
            ...
            switch (property) {
                ...
                default:
                    ...
                    switch (op) {
                        ...
                        case '$eq':
                            if (typeof comparison.$eq === 'undefined' || comparison.$eq == null) return sprintf.sprintf('(%s IS NULL)', escapedProperty);
                        ...
                        case '$ne':
                            if (typeof comparison.$ne === 'undefined' || comparison.$ne == null) return sprintf.sprintf('(NOT %s IS NULL)', escapedProperty);
        ...
        value: function formatSelect(obj) {
            ...
            var joins = [];
            if (obj.$expand != null) {
                if (_.isArray(obj.$expand)) joins = obj.$expand;else joins.push(obj.$expand);
            }
            //get entity fields
        ...
        value: function formatField(obj) {
            ...
            if ((typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) === 'object') {
                var _ret = function () {
                    ...
                    if (obj.hasOwnProperty('$value')) return {
                            v: _this.escapeConstant(obj['$value'])
                        };
                    //get table name
