...
var util = require('util'),
    _ = require('lodash'),
    HtmlWriter = require('./html').HtmlWriter,
    SequentialEventEmitter = require('./emitter').SequentialEventEmitter,
    errors = require('./resources/http-error-codes.json'),
...
var common = {
    ...
    SequentialEventEmitter: SequentialEventEmitter,
