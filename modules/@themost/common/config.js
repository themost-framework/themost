...
exports.ActiveModuleLoaderStrategy = exports.DefaultModuleLoaderStrategy = exports.ModuleLoaderStrategy = exports.ConfigurationStrategy = exports.ConfigurationBase = undefined;
...
var ActiveModuleLoaderStrategy = exports.ActiveModuleLoaderStrategy = function (_ModuleLoaderStrategy2) {
    _inherits(ActiveModuleLoaderStrategy, _ModuleLoaderStrategy2);
    ...
    function ActiveModuleLoaderStrategy(config) {
        _classCallCheck(this, ActiveModuleLoaderStrategy);

        var _this3 = _possibleConstructorReturn(this, (ActiveModuleLoaderStrategy.__proto__ || Object.getPrototypeOf(ActiveModuleLoaderStrategy)).call(this, config));

        _this3[watchersProperty] = {};
        return _this3;
    }
    ...
    _createClass(ActiveModuleLoaderStrategy, [{
        key: 'require',
        ...
        value: function (_require2) {
            ...
            var finalModulePath = PathUtils.join(this.getConfiguration().getExecutionPath(), modulePath);
            //try to load the given module
            var resultModule = require(finalModulePath);
            var resolvedModulePath = require.resolve(finalModulePath);
    ...
    return ActiveModuleLoaderStrategy;
}(ModuleLoaderStrategy);
