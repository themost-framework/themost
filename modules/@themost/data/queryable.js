        ...
        value: function resolveNestedAttribute(attr) {
            ...
            if (typeof attr === 'string' && /\//.test(attr)) {
                var _ret = function () {
                    ...
                    if (expr) {
                        if (typeof _this.query.$expand === 'undefined' || null) {
                            _this.query.$expand = expr;
                        } else {
                            arr = [];
                            if (!_.isArray(self.query.$expand)) {
                                arr.push(self.query.$expand);
                                _this.query.$expand = arr;
                            }
                            arr = [];
    ...
    _createClass(DataQueryable, [{
        ...
        value: function first(callback) {
            ...
            if (typeof callback !== 'function') {
                var _ret4 = function () {
                    var d = Q.defer();
                    firstInternal.call(_this2, function (err, result) {
                        if (err) {
                            return d.reject(err);
                        }
                        d.resolve(result);
        ...
        value: function all(callback) {
            ...
            if (typeof callback !== 'function') {
                var _ret5 = function () {
                    var d = Q.defer();
                    allInternal.call(_this3, function (err, result) {
                        if (err) {
                            return d.reject(err);
                        }
                        d.resolve(result);
        ...
        value: function list(callback) {
            ...
            if (typeof callback !== 'function') {
                var _ret6 = function () {
                    var d = Q.defer();
                    listInternal.call(_this4, function (err, result) {
                        if (err) {
                            return d.reject(err);
                        }
                        d.resolve(result);
        ...
        value: function count(callback) {
            ...
            if (typeof callback !== 'function') {
                var _ret7 = function () {
                    var d = Q.defer();
                    countInternal.call(_this5, function (err, result) {
                        if (err) {
                            return d.reject(err);
                        }
                        d.resolve(result);
        ...
        value: function max(attr, callback) {
            ...
            if (typeof callback !== 'function') {
                var _ret8 = function () {
                    var d = Q.defer();
                    maxInternal.call(_this6, attr, function (err, result) {
                        if (err) {
                            return d.reject(err);
                        }
                        d.resolve(result);
        ...
        value: function min(attr, callback) {
            ...
            if (typeof callback !== 'function') {
                var _ret9 = function () {
                    var d = Q.defer();
                    minInternal.call(_this7, attr, function (err, result) {
                        if (err) {
                            return d.reject(err);
                        }
                        d.resolve(result);
        ...
        value: function average(attr, callback) {
            ...
            if (typeof callback !== 'function') {
                var _ret10 = function () {
                    var d = Q.defer();
                    averageInternal_.call(_this8, attr, function (err, result) {
                        if (err) {
                            return d.reject(err);
                        }
                        d.resolve(result);
        ...
        value: function value(callback) {
            ...
            if (typeof callback !== 'function') {
                var _ret11 = function () {
                    var d = Q.defer();
                    valueInternal.call(_this9, function (err, result) {
                        if (err) {
                            return d.reject(err);
                        }
                        d.resolve(result);
                    ...
                    if (expand instanceof DataAssociationMapping) {
                        ...
                        var _ret16 = function () {
                            ...
                            if (typeof expand === 'string') {
                                ...
                                return {
                                    v: callback(new Error("Invalid expand option. Expected string or a named object."))
                                };
                            }
