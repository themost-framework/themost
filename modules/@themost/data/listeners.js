...
exports.DataModelSubTypesListener = exports.DataModelSeedListener = exports.DataModelCreateViewListener = exports.DefaultValueListener = exports.DataCachingListener = exports.CalculatedValueListener = exports.UniqueContraintListener = exports.NotNullConstraintListener = undefined;
...
var NotNullConstraintListener = exports.NotNullConstraintListener = function () {
    ...
    _createClass(NotNullConstraintListener, [{
        ...
        value: function beforeSave(e, callback) {
            ...
            var attrs = e.model.attributes.filter(function (x) {
            ...
            async.eachSeries(attrs, function (attr, cb) {
                var name = attr.property || attr.name,
                    value = e.target[name];
                if ((value == null || value === undefined) && e.state == 1 || value == null && typeof value !== 'undefined' && e.state == 2) {
...
var UniqueContraintListener = exports.UniqueContraintListener = function () {
    function UniqueContraintListener() {
        _classCallCheck(this, UniqueContraintListener);
    }

    _createClass(UniqueContraintListener, [{
        key: 'beforeSave',
            ...
            async.eachSeries(constraints, function (constraint, cb) {
                ...
                for (var i = 0; i < constraint.fields.length; i++) {
                    ...
                    if (typeof mapping !== 'undefined' && mapping !== null) {
                        if (_typeof(e.target[attr]) === 'object') {
    ...
    return UniqueContraintListener;
}();
        ...
        value: function afterUpgrade(event, callback) {
            ...
            if (_.isObject(baseModel)) {
                baseModel.attributes.forEach(function (x) {
                    ...
                    if (!x.primary && !x.many) baseFields.push(qry.fields.select(x.name).from(baseAdapter));
                });
            }
