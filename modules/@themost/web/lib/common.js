...
var HttpApplicationOptions = exports.HttpApplicationOptions = function HttpApplicationOptions() {
  ...
  if (process.NODE_ENV === 'development') this.port = 80;
  this.bind = '0.0.0.0';
  this.cluster = 0;
};
...
var HttpApplicationConfig = exports.HttpApplicationConfig = function HttpApplicationConfig() {
  _classCallCheck(this, HttpApplicationConfig);
