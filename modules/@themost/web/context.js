...
exports.HttpContext = exports.HttpContextParams = undefined;
...
var HttpContextParams = exports.HttpContextParams = function () {
    function HttpContextParams() {
        _classCallCheck(this, HttpContextParams);
    }
    //
    ...
    _createClass(HttpContextParams, [{
        key: 'getAttribute',
        value: function getAttribute(name) {
            if (typeof name === 'string') {
                ...
                var p = _.find(_.keys(this), function (x) {
                    return re.test(x);
                });
                if (p) return this[p];
            }
...
var HttpContext = exports.HttpContext = function (_DefaultDataContext) {
    ...
    function HttpContext(app, request, response) {
         ...
         */
        _this.params = new HttpContextParams();
