    ...
    app.module.directive('ejsInclude', function ($context, $angular, $qs, $sce) {
                    ...
                    pre: function preLink(scope, element) {
                        ...
                        try {
                            (function () {
                                ...
                                if (_lodash._.isNil(scope.state)) {
        ...
        return {
            ...
            link: function link(scope, element, attrs) {
                 ...
                 * @private
                 */
                if (attrs.title) element.attr('title', $context.translate(attrs.title, attrs.ejsLoc));
                if (attrs.placeholder) element.attr('placeholder', $context.translate(attrs.placeholder, attrs.ejsLoc));
            }
        };
...
//# sourceMappingURL=server_directives.js.map
