...
var fs = require('fs');
var HttpRoute = require('../common').HttpRoute;
var xml = require('most-xml');
...
var DataTypeValidator = require('@themost/data').validators.DataTypeValidator;
var MinLengthValidator = require('@themost/data').validators.MinLengthValidator;
var MaxLengthValidator = require('@themost/data').validators.MaxLengthValidator;
var MinValueValidator = require('@themost/data').validators.MinValueValidator;
var MaxValueValidator = require('@themost/data').validators.MaxValueValidator;
var RequiredValidator = require('@themost/data').validators.RequiredValidator;
var PatternValidator = require('@themost/data').validators.PatternValidator;
...
ViewHandler.STR_CONTROLLER_FILE = '../controllers/%s.js';
...
ViewHandler.queryControllerClass = function(controllerName, context, callback) {
    ...
    if (typeof controllerName === 'undefined' || controllerName===null) {
        ...
        var controllerPath = context.application.mapPath(sprintf(ViewHandler.STR_CONTROLLER_RELPATH, _.dasherize(controllerName))),
            ...
            try {
                ...
                if (!exists) {
                    ...
                    if (controllerModel) {
                        ...
                        controllerPath = context.application.mapPath(sprintf(ViewHandler.STR_CONTROLLER_RELPATH, controllerType));
                        fs.exists(controllerPath, function(exists) {
                           if (!exists) {
...
ViewHandler.prototype.postMapRequest = function (context, callback) {
    try {
        ViewHandler.prototype.preflightRequest.bind(this)(context, function(err) {
...
function httpParamValidationFailedCallback_(context, httpParam, validationResult, callback) {
    "use strict";
    ...
    return callback(new HttpBadRequestError('Bad request parameter', httpParam.message || validationResult.message));
}
    ...
    try {
        ...
        if (controller) {
            ...
            if (action) {
                 ...
                 */
                var fn;
                var useHttpMethodNamingConvention = false;
                    ...
                    if (_.isObject(fn.httpParam)) {
                        ...
                        if (_.isObject(httpParam)) {
                            if (typeof httpParam.type === 'string') {
                                ...
                                if (validationResult) {
                                    return httpParamValidationFailedCallback_(context, httpParam, validationResult, callback);
                                }
                            }
                ...
                if (useHttpMethodNamingConvention) {
                    ...
                    if (_.isPromise(methodResult)) {
                        ...
                        return callback(new HttpError(501));
                    }
                }
                /**
                 * @type HttpResult
 ...
 * @returns ViewHandler
 * */
ViewHandler.createInstance = function () {
...
if (typeof exports !== 'undefined') {
    ...
    module.exports.createInstance = function() {
        return ViewHandler.createInstance();
    };
}
