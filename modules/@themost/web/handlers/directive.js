 ...
 * @param callback
 */
DirectiveHandler.prototype.postExecuteResult = function(args, callback) {
    try {
         ...
         * @private
         */
        var HttpInternalProvider = function ($context, $qs) {
 ...
 * @returns {DirectiveHandler}
 */
DirectiveHandler.createInstance = function() {
    return new DirectiveHandler();
};

if (typeof exports !== 'undefined') {
    module.exports.createInstance = DirectiveHandler.createInstance;
}